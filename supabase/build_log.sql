...
-- 2026-04-16: add taxa rank 'superfamily' into table taxa, and make it root (no further parent).
-- Update trigger tgr_validate_parent_child_rank for taxa rank validation.
